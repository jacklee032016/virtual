 ...
 * @file
 *
 * Definition of exception vectors, implementation of reset (and startup handler), Preparation of the IRQ mode.
 *
...
bss_clear_loop:
    ...
    @ This should be disabled by default, but it does not hurt...
