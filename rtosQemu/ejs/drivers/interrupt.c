...
static void __defaultVectorIsr(void)
{
	...
	*/
	...
	{
		if ( __irqVect[cntr].irq >= 0 && __irqVect[cntr].irq < NR_INTERRUPTS &&
...
{
	/* Vectored implementation, a.k.a. "Vectored interrupt flow sequence", described on page 2-9 of DDI0181. */
